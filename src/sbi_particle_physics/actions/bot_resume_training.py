...
model = BackupManager.load_model_basic(directory)
BackupManager.train_model_with_backups(model, stop_after_epochs=DEFAULT_STOP_AFTER_EPOCH, max_epochs=DEFAULT_MAX_EPOCHS, directory=directory, resume=True, delete_old_backups=False)
