...
model, _ = Backup.load_data_and_build_model(DATA_DIR / f"data_2", batchsize=DEFAULT_DATA_FILE_BATCH_SIZE, stride=DEFAULT_STRIDE, pre_N=DEFAULT_PRE_N, preruns=DEFAULT_PRERUNS, seed=DEFAULT_SEED, max_files=DEFAULT_MAX_FILES)
